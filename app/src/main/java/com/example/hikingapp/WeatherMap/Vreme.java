...
public class Vreme extends AppCompatActivity implements View.OnClickListener {
    ...
    /*
   public void locate(View view) {
        locationButton = findViewById(R.id.lokacija);
        locationButton.setOnClickListener(this);
    }
    */
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(Vreme.this, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                (Vreme.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(Vreme.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
