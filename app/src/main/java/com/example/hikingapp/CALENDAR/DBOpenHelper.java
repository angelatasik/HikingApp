...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    void SaveEvent(String event, String time, String date, String month, String year,String notify,SQLiteDatabase database){
    ...
    public Cursor ReadEvents(String date, SQLiteDatabase database){
        ...
        String [] SelecitonArgs= {date};
        return  database.query(DBStructure.EVENT_TABLE_NAME,Projections,Selection,SelecitonArgs,null,null,null);
    }
    ...
    public Cursor ReadIDEvents(String date,String event,String time,SQLiteDatabase database){
        ...
        String [] SelecitonArgs= {date,event,time};
        return  database.query(DBStructure.EVENT_TABLE_NAME,Projections,Selection,SelecitonArgs,null,null,null);
    }
    ...
    public Cursor ReadEventsPerMonth(String month, String year, SQLiteDatabase database){
        ...
        String [] SelecitonArgs = {month,year};
        return  database.query(DBStructure.EVENT_TABLE_NAME,Projections,Selection,SelecitonArgs,null,null,null);
    }
